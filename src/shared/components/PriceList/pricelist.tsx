        ...
        <div className="prices-container-element">
          ...
          <div className="prices-container-element-name">
            <p>
              ...
              <span className="prices-container-element-name-description">
                (Delikatny makijaż w kolorach neutralnych, podkreślone rzęsy bez
                kępek){" "}
              </span>
            </p>{" "}
            <p>150zł</p>
          ...
          <div className="prices-container-element-name">
            <p>
              ...
              <span className="prices-container-element-name-description">
                (Kępki rzęs , rozświetlenie dekoltu, ewentualne ozdoby w postaci
                kryształków, zestaw ratunkowy)
              </span>
            </p>{" "}
            <p>250zł</p>
          </div>
